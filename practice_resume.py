            ...
            <div class="accordion accordion-flush" id="accordionFlushExample">
              <div class="accordion-item">
                ...
                <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">University of Toronto st.george (Bachelor of Science in Mathematics and Statistics)
                  <div class="accordion-body">- Specialization: Mathematics, Data Analysis, Data Engineering
                  </div>
                  </div>
                </div>
              </div>
              <div class="accordion-item">
                ...
                <div id="flush-collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">Languages: English, Korean</div>
                  <div class="accordion-body">Programming: R, Python, Airflow, Shell-Script, Elasticsearch, Fastapi, Bootstrap</div>
                  <div class="accordion-body">Microsoft Office: Word, PowerPoint, Excel</div>
                </div>
              </div>
              <div class="accordion-item">
                <h2 class="accordion-header">
                ...
                <div id="flush-collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                  <div class="accordion-body">UTKSA (University of Toronto Korean Student Association) chief science director
                  <div class="accordion-body">- Tutor of MAT135,136 (AP Calculus A,B) for two years</div>
                  <div class="accordion-body">- Manage Science Mentorship Seminar Program with alumni of University of Toronto who are working on Statistics, Medical parts (especially financial district, Dental, and Medication)
                  </div>
                </div>
              </div>
            </div>
