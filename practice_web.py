        ...
        <body>
            <nav class="navbar navbar-expand-lg bg-body-tertiary">
              <div class="container-fluid">
                <a class="navbar-brand" href="#">NHN_DATA PIRATES</a>
            ...
            <div class="card mx-auto" style="width: 18rem;">
                ...
                <div class="card-body">
                    <h5 class="card-title">이름: 현찬호</h5>
                    <p class="card-text">데이터기술팀 고잉메리호 선장</p>
                    <a href="https://www.linkedin.com/in/chanhohyun/?originalSubdomain=kr" class="btn btn-primary">LinkedIn</a>
                    <a href="https://www.instagram.com/hch16/?hl=ko" class="btn btn-secondary">Instagram</a>
                </div>
            </div>
            <div class="row">
                <div class="col">   <div class="card" style="width: 18rem; height: 23rem;"> 
                    <img src="http://whatsup.nhnent.com/owfs/read/226697/f0a8acdf-a175-4241-bf30-4a0a5f6d4711" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">이름: 강동구</h5>
                        <p class="card-text">1번 항해사</p>
                        <a href="https://www.linkedin.com/in/chanhohyun/?originalSubdomain=kr" class="btn btn-primary">LinkedIn</a>
                        <a href="https://www.instagram.com/hch16/?hl=ko" class="btn btn-secondary">Instagram</a>
                    </div>
                    </div>
                ...
                <div class="col">   <div class="card" style="width: 18rem; height: 23rem;">
                    <img src="http://whatsup.nhnent.com/owfs/read/216803/9990c6e8-4221-476e-9060-806addcb4446" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">이름: 이경수</h5>
                        <p class="card-text">2번 항해사</p>
                        <a href="https://www.linkedin.com/in/chanhohyun/?originalSubdomain=kr" class="btn btn-primary">LinkedIn</a>
                        <a href="https://www.instagram.com/hch16/?hl=ko" class="btn btn-secondary">Instagram</a>
                    </div>
                    </div>
                ...
                <div class="col">   <div class="card" style="width: 18rem; height: 23rem;">
                    <img src="http://whatsup.nhnent.com/owfs/read/215473/17a27d59-580f-4b5a-a0a2-d7f079ce6414" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">이름: 이현준</h5>
                        <p class="card-text">갑판장</p>
                        <a href="https://www.linkedin.com/in/chanhohyun/?originalSubdomain=kr" class="btn btn-primary">LinkedIn</a>
                        <a href="https://www.instagram.com/hch16/?hl=ko" class="btn btn-secondary">Instagram</a>
                    </div>
                    </div>
                ...
                <div class="col">   <div class="card" style="width: 18rem; height: 23rem;">
                    <img src="http://whatsup.nhnent.com/owfs/read/213530/ac3518a6-2dfa-4292-8dcb-4f3d84b7a7b8" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">이름: 김규찬</h5>
                        <p class="card-text">조타수</p>
                        <a href="https://www.linkedin.com/in/chanhohyun/?originalSubdomain=kr" class="btn btn-primary">LinkedIn</a>
                        <a href="https://www.instagram.com/hch16/?hl=ko" class="btn btn-secondary">Instagram</a>
                    </div>
                    </div>
